...
![Gambar 1. Tampilan jendela pada software R.](https://github.com/user-attachments/assets/0b64106e-e988-455a-bbf5-7462c5d64584)
...
![Gambar 2. Tampilan jendela pada software R-Studio](https://github.com/user-attachments/assets/3f302a72-a629-41cd-93c8-bd00693e8f72)
...
[1] artinya data setelah tanda itu adalah data nomor pertama (baris pertama). Jika data yang kita input salah, misalnya data nomor 4 seharusnya 12 dan bukan 13, maka
...
> data^2-mean(data)
[1]   77.6  706.6  553.6  146.6  461.6  266.6  338.6  506.6
[9]  377.6 2378.6
...
![Gambar 3. Output R untuk distribusi normal dari 1000 angka acak](https://github.com/user-attachments/assets/52fc43df-830c-498d-9ebd-174a3147f6fe)
...
a. Indeks massa tubuh dengan rumus: imt<-weight/heigth^2

b. Rataan data (mean)

c. Simpangan baku

d. Plot yang sesuai untuk data tinggi dan berat badan
...
J Horton, N. and Kleinman, K. (2015) Using R and RStudio for Data Management, Statistical Analysis, and Graphics. second. Boca Raton, Florida: CRC Press, Taylor & Francis Group.
