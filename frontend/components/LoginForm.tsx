...
const LoginForm = () => {
  const { user, googleSignIn, emailSignIn, register } = UserAuth();
          ...
          <div className="rounded-md shadow-2xl p-7 md:p-14 bg-white">
            <div className="flex mb-6 border-b">
              <button
                ...
                className={`flex-1 pb-2 text-center font-semibold ${
                  mode === "login" ? "text-[#00726B] border-b-2 border-[#00726B]" : "text-gray-400"
                }`}
              >
                Masuk
              </button>
              <button
                ...
                className={`flex-1 pb-2 text-center font-semibold ${
                  mode === "register" ? "text-[#00726B] border-b-2 border-[#00726B]" : "text-gray-400"
                }`}
              >
                Daftar
              </button>
            ...
            <form onSubmit={handleSubmit} className="text-center ">
              ...
              <p className="text-base md:text-xl font-light text-gray-400 mb-8">
                {mode === "login" ? "Halo, ayo semangat belajar!" : "Daftar untuk mulai belajar statistika"}
              </p>

              {error && (
                <p className={`text-sm mb-4 ${error.includes("Berhasil") ? "text-green-600" : "text-red-500"}`}>
                  {error}
                </p>
              )}
              ...
              {mode === "login" && (
                <>
                  <p className="text-center my-7 font-light text-gray-400 ">Atau masuk dengan</p>
                  <button
                    type="button"
